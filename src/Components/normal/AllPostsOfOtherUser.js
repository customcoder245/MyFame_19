...
import { setUserProfileImageVideoScroll, setUserVideoScroll } from "../../redux/action";
import { useDispatch } from "react-redux";
import { useFocusEffect } from "@react-navigation/native";
import AllPostsFetchOfOtherUserFetch from "../../Fetch_API/AllPostsFetchOfOtherUserFetch";
import { Ionicons } from "@expo/vector-icons";

const AllPostsOfOtherUser = (props) => {
  ...
  useFocusEffect(
    useCallback(() => {
      const fetchPostData = async () => {
        try {
          const response = await AllPostsFetchOfOtherUserFetch(userId);
          // console.log("ALL POSTS (Other User):", response);
