...
// import { TextInput } from "react-native--handler";
// import { no1 } from "../../assets2/Icons/allIcogesturens";
// import { BASE_URL } from "../../Fetch_API/BaseURL";
// import store from "../../redux/store";
// import NoOfLikesData from "./NoOfLikes";
...
//   const { videoid } = route.params; // Retrieve videoid passed from the previous screen
//   const [likedUsers, setLikedUsers] = useState([]); // For storing liked users from the API
...
//   useEffect(() => {
//     NoOfLikesData(videoid , userid)
//       .then((data) => {
//         if (!data.error) {
//           setLikedUsers(data); // Set the liked users
//           setFilteredUsers(data); // Set the filtered users to display all initially
//         } else {
//           setError("No Likes");
//         }
//       })
//       .catch((error) => setError("No Likes"))
