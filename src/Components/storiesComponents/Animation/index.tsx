...
import Animated, { Extrapolation, interpolate, runOnUI, useAnimatedStyle, withTiming } from 'react-native-reanimated';
import { HEIGHT, WIDTH } from '../constants';
import { AnimationProps } from '../componentsDTO';
...
const StoryAnimation: FC<AnimationProps> = ( { children, x, index } ) => {
  ...
  const animatedStyle = useAnimatedStyle( () => {
    ...
    const translateX1 = rotateY > 0 ?w * 0.01: -w * 0.01;
