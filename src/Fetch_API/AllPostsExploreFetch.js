...
const AllPostsExploreFetch = async (userId,watch_type='everyone',post_type='videos') => {


  try {
    const response = await fetch(
      `${BASE_URL}/explorevideos/v1/explorevideos/`,
...
export default AllPostsExploreFetch;
